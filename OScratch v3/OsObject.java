...
/**
 * Clase de base tanto para el escenario como para los actores. Desarrolla las
 * funciones que son comunes a ambos objetos.
 *
...
abstract class OsObject {
     ...
     * disfraz actual.
     *
     * @param label Permite configurar la etiqueta que se mostrara al actor o
     * escenario.
     */
     ...
     * inserte un nuevo actor en el entorno de juego. El creador del juego podrá
     * sobreescribir esta función para realizar las acciones que considere
    ...
    /**
     * El sistema llamará a esta función cuando se mande un mensaje. El creador
     * del juego podrá sobreescribir esta función para realizar las acciones en
     * respuesta al evento de mensaje.
     */
    ...
    /**
     * El sistema llamará a esta función cuando se pulse una tecla. El creador
     * del juego podrá sobreescribir esta función para realizar las acciones en
     * respuesta al evento de tecla pulsada.
     */
    ...
    /**
     * El sistema llamará a esta función cuando se pulse un objeto. El creador
     * del juego podrá sobreescribir esta función para realizar las acciones en
     * respuesta al evento de objeto presionado.
     */
    ...
    /**
     * Envía a todos los objetos del juego el mensaje especificado en el
     * argumento y detiene el hilo desde el que se llamó a la función hasta que
     * terminen de ejecutarse la respuesta al mensaje por parte de todos los
     * objetos.
     *
     * @param msg Mensaje que se enviará.
     */
    ...
    /**
     * Muesta en pantalla la variable interna de la última respuesta dada por un
     * usuario.
     */
     ...
     *
     * @return True si la última respuesta dada por el usuario es un número real
...
//        esperar(0.001);
    ...
    /**
     * Calcula un número al azar comprendido entre los dos números del
     * argumento.
     *
